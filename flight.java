...
public class flight {
	    ...
	    for(int i=1;i<4;){
	    	...
	    	if(user.equals("arun") && password.equals("1234")){
	    		...
	    		for(int x=1; x==1;){
	    			...
	    			for(x=1; x==1;){
						...
						if (choice.equals("1")){
	    					...
	    					System.out.println("***************************************");
	    					System.out.println("**   DESTINATION         |  AMOUNT  |  SEATS  **");
	    					System.out.println("***************************************");
							System.out.println("** 1.)BRAZIL             |    80$ 	| "+available[1]+"  **");
	    					System.out.println("** 2.)CHILE  		 |    78$  	| "+available[2]+"  **");
	    					System.out.println("** 3.)ARGENTINA          |    60$ 	| "+available[3]+"  **");
	    					System.out.println("** 4.)CROATIA            |    58$ 	| "+available[4]+"  **");
	    					System.out.println("** 5.)MEXICO             |    85$ 	| "+available[5]+"  **");
	    					System.out.println("***************************************");
							System.out.println("***************************************\n");
	    					System.out.println(" Please specify the senior citizen count in the upcoming form -> \n");	
	    					x=0;
						}
	    					...
	    					String dest[] = { " ", "BRAZIL", "CHILE", "ARGENTINA", "CROATIA", "MEXICO"};
	    					...
	    					for(x=1; x==1;){
	    					System.out.print("TOTAL PASSENGERS ?: ");
	    					...
	    					for(x=1;x==1;){
	    						System.out.print("IS THERE ANY SENIOR CITIZEN(s).IF YES, ENTER THEIR COUNT?: ");
	    					...
	    					if(print==1){
	    						...
	    						System.out.println("NO. OF PASSENGERS WHO ARE SENIOR CITIZEN(s): " + ticketI[z][1]);
	    						System.out.println("***************************************");
	    						System.out.println("***************************************\n");
	    						ticketS[z][2]="0";
							...
							for(x=1; x==1;){
									...
									for(int b=0;b<z;b++){
										if(search.equalsIgnoreCase(ticketS[b][0])){
		    								...
		    								System.out.println("NO. OF PASSENGERS WHO ARE SENIOR CITIZEN(s): " + ticketI[b][1]);
			 		   						System.out.println("***************************************");
		    								System.out.println("***************************************");
		    								s=0;
											x=0;
	    					...
	    					search = in.readLine();
								...
								for(x=0; x<=z; x++){
									if(search.equalsIgnoreCase(ticketS[x][0])){
	    								...
	    								System.out.println("NO. OF PASSENGERS WHO ARE SENIOR CITIZEN(s): " + ticketI[x][1]);
	    			...
	    			for(y=1; y==1;){
	    				...
	    				if (yn.equalsIgnoreCase("y")){
	    					...
	    					System.out.println("\nThank You!!! Have a safe and happy flight ");
	    					break;
	    				}
	    				else{
	    					System.out.println("Invalid Input!!!");
